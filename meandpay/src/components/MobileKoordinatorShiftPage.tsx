          ...
          {step === 'upload' && (
            <div className="p-6 space-y-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-2xl bg-teal-50 border border-teal-100 gap-4">
                ...
                <button onClick={() => generateMappingTemplate(shifts, allEmployees)} className="px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white text-xs font-bold rounded-xl whitespace-nowrap">
                  Unduh Template
                </button>
              </div>
              <div
